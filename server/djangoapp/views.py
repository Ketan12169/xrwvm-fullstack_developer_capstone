...
def get_dealer_reviews(request, dealer_id):
    ...
    if dealer_id:
        ...
        if not reviews:  # No reviews found
        ...
        for review_detail in reviews:
            try:
                ...
                print(f"Error analyzing sentiment for review: {review_detail['review']} - {e}")
                review_detail['sentiment'] = "Unknown"  # Handle error gracefully
